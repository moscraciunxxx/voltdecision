...
import { rc } from "../engine/geometry";
...
export function FieldMap({ v, spec, residual, mode }: Props) {
  ...
  useEffect(() => {
    ...
    ctx.stroke();
  }, [v, spec, residual, mode]);

  return <canvas ref={ref} className="field" width={420} height={420} aria-label="Tissue voltage field" />;
}
